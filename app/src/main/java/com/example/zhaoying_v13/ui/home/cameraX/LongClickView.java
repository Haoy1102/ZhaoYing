...
public class LongClickView extends View {
    ...
    private boolean mIsPhotoModel;//是否在拍照
    ...
    private void getAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        //annulusColor 圆环的颜色
        DEFAULT_ANNULUS_COLOR = context.getResources().getColor(R.color.grayDark);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCount.get() > 0) {
            ...
            canvas.drawArc(rectF, -90, perAngle * mCount.get(), true, mAngleCirclePaint);
        }
